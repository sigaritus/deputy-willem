...
/**
 * Implementation of the Tiny Encryption Algorithm (TEA). The Tiny Encryption
 * Algorithm is one of the fastest and most efficient cryptographic algorithms
 * in existence. It was developed by David Wheeler and Roger Needham at the
 * Computer Laboratory of Cambridge University.
 * 
 * See http://www.cl.cam.ac.uk/ftp/users/djw3/tea.ps
 * 
 * This software was written to provide simple encryption for J2ME. The homepage
 * for this software is http://winterwell.com/software/TEA.php
 * 
...
public class TEA {
	...
	public byte[] encrypt(byte[] clear) {
		int paddedSize = ((clear.length / 8) + (((clear.length % 8) == 0) ? 0
				: 1)) * 2;
